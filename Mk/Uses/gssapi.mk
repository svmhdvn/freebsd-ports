...
_GSSAPI_DEPENDS=	${GSSAPILIBDIR}/libgssapi.so:security/${GSSAPI_VER}
...
_HEADERS+=	gssapi/gssapi.h gssapi/gssapi_krb5.h krb5.h
.    if !defined(_KRB_BOOTSTRAP)
_GSSAPI_DEPENDS=	${GSSAPILIBDIR}/libkrb5support.so:security/krb5${GSSAPI_VER:S/mit//}
BUILD_DEPENDS+=		${_GSSAPI_DEPENDS}
RUN_DEPENDS+=		${_GSSAPI_DEPENDS}
.    else
PREFIX=		${KRB5_HOME}
