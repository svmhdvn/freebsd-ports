...
add-plist-phpext:
	...
	@${ECHO_CMD} '@postexec echo "#include \"ext/${PHP_MODNAME}/config.h\"" >> $${PKG_ROOTDIR}%D/include/php/ext/php_config.h' \
		>> ${TMPPLIST}
	@${ECHO_CMD} '@preunexec cp $${PKG_ROOTDIR}%D/include/php/ext/php_config.h $${PKG_ROOTDIR}%D/include/php/ext/php_config.h.orig' \
		>> ${TMPPLIST}
	@${ECHO_CMD} '@preunexec grep -v ext/${PHP_MODNAME}/config.h $${PKG_ROOTDIR}%D/include/php/ext/php_config.h.orig > $${PKG_ROOTDIR}%D/include/php/ext/php_config.h || true' \
		>> ${TMPPLIST}
	@${ECHO_CMD} '@preunexec ${RM} $${PKG_ROOTDIR}%D/include/php/ext/php_config.h.orig' \
		>> ${TMPPLIST}
